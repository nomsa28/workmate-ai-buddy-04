...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "AI assistant for professional emails, meeting summaries and task planning." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "WorkMate AI — Workplace Productivity Assistant" },
      { property: "og:description", content: "AI assistant for professional emails, meeting summaries and task planning." },
